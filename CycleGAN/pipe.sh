...
# python train.py --dataroot ./datasets/jta_2_duke/ --name exp_resnet9_prcp --model cycle_gan --netG resnet_9blocks --n_epochs 10 --n_epochs_decay 10 --use_PRCP

python generate_results.py --dataroot datasets/jta_2_duke/ --name exp_resnet9_prcp --model cycle_gan --num_test 200000 --netG resnet_9blocks --results_dir ../../datasets/jta_2_duke_resnet9_prcp/bounding_box_train/ --load_size 256